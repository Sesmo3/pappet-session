            ...
            Malvin.ev.on("connection.update", async (s) => {
                ...
                if (connection === "open") {
                    ...
                    const sid = megaUrl.includes("https://mega.nz/file/")
                        ? 'pappet-MD~' + megaUrl.split("https://mega.nz/file/")[1]
                        : 'Error: Invalid URL';
...
💡 *Whats Next?* 
1️⃣ Explore all the cool features of PAPPET MD.
...
⭐ *Show Some Love!* Give us a ⭐ on GitHub and support the developer of: 👉 [Sesmo GitHub Repo](https://github.com/Sesmo3/)  

🚀 _Thanks for choosing PAPPET MD — Let the automation begin!_ ✨`;
